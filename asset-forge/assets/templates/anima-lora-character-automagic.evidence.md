# anima-lora-character-automagic — reconstructed evidence card

- Version: `2026-08-30-reconstructed`
- Scope: Reconstructed candidate after F-S4-002 template loss; original bytes unavailable.
- Evidence status: `reconstructed`; old frozen hash is retained for comparison only.
- Aliases / 检索关键词: reconstructed, F-S4-002, anima-lora-character-automagic
